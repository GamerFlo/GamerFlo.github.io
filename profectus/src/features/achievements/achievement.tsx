...
export const msDisplayOptions = Object.values(AchievementDisplay).map(option => ({
    label: camelToTitle(option),
    value: option
}));

export const difficultyOptions = Object.values(Difficulty).map(option => ({
    label: camelToTitle(option),
    value: option
}));
