...
import { BaseLayer, createLayer, Layer } from "game/layers";
...
import { createCostRequirement, createVisibilityRequirement } from "game/requirements";
                ...
                <>
                    <div class="modifier-container">
                        ...
                        <span class="modifier-amount">
                            {letterFormat(unref(processed.base[i]) ?? 1)}
                            {s.unit}
                        </span>
                    </div>
